...
import { addDoc, collection, doc, DocumentReference, serverTimestamp, setDoc, updateDoc} from '@firebase/firestore';
...
const UpdateStock = () => {
  ...
  const initialState = {
    ...
    // company_address:"",
    product_name:"",
    product_Qty: parseInt(0),
    product_description:""
  }
  const [data, setData] = useState(initialState);
  const {company_name,company_email,company_address,product_name,product_Qty,product_description} = data;
  ...
  return (
    <div className="w-full md:p-8 md:w-2/3 md:shadow mx-auto mt-8 rounded p-3 my-8">
      ...
      <form className="w-full mx-auto flex flex-col" onSubmit={handleSubmit}>
        ...
        <button type='submit' 
        className="bg-[rgb(255,_101,_132)] text-gray-100 w-full p-5 rounded my-6"

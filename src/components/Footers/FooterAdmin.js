...
export default function FooterAdmin() {
  return (
    <>
      <footer className="block py-4 font-normal">
            ...
            <div className="w-full md:w-4/12 px-4">
              <div className="text-sm text-blueGray-500  py-1 text-center md:text-left">
                ...
                <a
                  ...
                  className="text-blueGray-500 hover:text-blueGray-700 text-sm  py-1"
                >
                  HackyRaji
                </a>
              </div>
            ...
            <div className="w-full md:w-8/12 px-4">
              <ul className="flex flex-wrap list-none md:justify-end  justify-center">
                <li>
                  <a
                    href="https://www.creative-tim.com?ref=nr-footer-admin"
                    className="text-blueGray-600 hover:text-blueGray-800 text-sm block py-1 px-3"
                  >
                    HackyRaji
                  </a>
                </li>
